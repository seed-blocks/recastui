/**
 * Credits: TailwindCSS/forms and the TailwindCSS team/
 * This code has been copied from https://github.com/tailwindlabs/tailwindcss-forms/blob/master/src/index.js
 */
		...
		const rules = [
			{
				...
				styles: {
					...
					'&:focus': {
						...
						'--tw-ring-offset-color': theme('colors.gray.1'),
						'--tw-ring-color': theme('colors.gray.10'),
					...
					'&[aria-invalid="true"]': {
						'border-color': theme('colors.error.9'),
					},
				},
			},
			{
			...
			},
			{
				...
				styles: {
					'background-image': `url("${svgToDataUri(
						`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16"><path stroke="${theme(
							'colors.gray.1',
