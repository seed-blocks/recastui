...
const variantClasses = {
	...
	solid: {
		...
		error: 'bg-error-9 hover:bg-error-10 text-white',
		info: 'bg-info-9 hover:bg-info-10 text-black',
		success: 'bg-success-9 hover:bg-success-10 text-white',
		warning: 'bg-warning-9 hover:bg-warning-10 text-black',
	},
	outline: {
		...
		error: 'bg-error-3 hover:bg-error-4 text-error-9 border-error-9',
		info: 'bg-info-3 hover:bg-info-4 text-info-9 border-info-9',
		success: 'bg-success-3 hover:bg-success-4 text-success-9 border-success-9',
		warning: 'bg-warning-3 hover:bg-warning-4 text-warning-9 border-warning-9',
	},
	ghost: {
		...
		error: 'hover:bg-error-3 text-error-9',
		info: 'hover:bg-info-3 text-info-9',
		success: 'hover:bg-success-3 text-success-9',
		warning: 'hover:bg-warning-3 text-warning-9',
	},
	link: {
		...
		error: 'underline hover:no-underline text-error-9 p-0',
		info: 'underline hover:no-underline text-info-9 p-0',
		success: 'underline hover:no-underline text-success-9 p-0',
		warning: 'underline hover:no-underline text-warning-9 p-0',
	},
};
