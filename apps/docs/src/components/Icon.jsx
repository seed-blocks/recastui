...
const iconStyles = {
  blue: '[--icon-foreground:theme(colors.slate.9)] [--icon-background:theme(colors.white)]',
  amber: '[--icon-foreground:theme(colors.amber.9)] [--icon-background:theme(colors.amber.1)]',
};
