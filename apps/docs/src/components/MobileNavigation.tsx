	...
	return (
		<>
			...
			<Dialog
				...
				<Dialog.Panel className='bg-gray-2 min-h-full w-full max-w-xs px-3 pt-4 pb-12'>
					<div className='flex items-center'>
						<button type='button' onClick={() => setIsOpen(false)} aria-label='Close navigation'>
							<IconX className='stroke-gray-12 h-6 w-6' />
						</button>
						<a href='/' className='ml-7' aria-label='Home page'>
							<div className='h-6 w-[108px] bg-[url("/Recastui_logo_light.svg")] dark:bg-[url("/Recastui_logo_dark.svg")] lg:hidden' />
						</a>
					</div>
