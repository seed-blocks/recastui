...
export function Header({ navigation }) {
  ...
  return (
    ...
    >
      <div className='max-w-8xl relative mx-auto flex w-full justify-center sm:px-2 lg:px-8 xl:px-12'>
        ...
        <div className='relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow'>
          ...
          <a href='https://github.com' className='group' aria-label='GitHub'>
            <GitHubIcon className='fill-gray-11 group-hover:fill-gray-12 h-7 w-7' />
          </a>
        </div>
      </div>
    </header>
