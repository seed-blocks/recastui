...
const docSearchConfig = {
  appId: import.meta.env.NEXT_PUBLIC_DOCSEARCH_APP_ID,
  apiKey: import.meta.env.NEXT_PUBLIC_DOCSEARCH_API_KEY,
  indexName: import.meta.env.NEXT_PUBLIC_DOCSEARCH_INDEX_NAME,
};
